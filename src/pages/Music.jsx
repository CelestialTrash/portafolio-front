    ...
    useEffect(() => {
        const fetchReleases = async () => {
            try {
                ...
                // Sort releases by date, assuming `data` has a `createdAt` field
                ...
                {releases.map((release) => (
                    <div key={release._id} className={styles.releaseCard}>
                        ...
                        <div className={styles.releaseInfo}>
                            ...
                            <a href={release.link} target="_blank" rel="noopener noreferrer" className={styles.releaseLink}>Listen</a>
                        </div>
                    </div>
                ))}
            </div>
